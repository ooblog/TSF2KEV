...
## TSF2KEVの「TSF.d --about」「TSF.py --about」より抜粋。
    ...
    echoCALC:
    	aboutCALCtest:	#TSF_this	aboutCALC:	#TSF_argvsthe	#TSF_reverseN	aboutCALC:	#TSF_lenthe	#TSF_echoN	echoTIME:	#TSF_this
    aboutCALCtest:
    	▽「calc」系準備中	#TSF_echo
    aboutCALC:
    ...
    echoTIME:
    	aboutTIMEtest:	#TSF_this	aboutTIME:	#TSF_argvsthe	#TSF_reverseN	aboutTIME:	#TSF_lenthe	#TSF_echoN
    aboutTIMEtest:
    	▽「time」系は準備中	#TSF_echo
    aboutTIME:
