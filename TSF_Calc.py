...
#    TSF_words["#TSF_calcRO"]=TSF_calc_calcRO; TSF_words["#端数処理"]=TSF_calc_calcRO
    ...
    global TSF_Calc_opeword,TSF_Calc_opechar,TSF_Calc_okusendic,TSF_Calc_rinmoudic,TSF_Calc_okusenyen,TSF_Calc_rinmouyen
...
def TSF_calc_comma_okusen(TSF_calcQ,TSF_calcT,TSF_calcC):    #TSF_doc:整数にコンマ処理。(TSFAPI)
    TSF_calcA=""
    TSF_calcCptr=0
...
def TSF_calc_comma_rinmou(TSF_calcQ,TSF_calcT,TSF_calcC):    #TSF_doc:小数にコンマ処理。(TSFAPI)
    TSF_calcA=""
    TSF_calcCptr=0
